...
export async function createTeam(params: CreateTeamParams) {
  try {
    ...
    logger.error("Error creating team", _error);
...
export async function updateTeam(params: UpdateTeamParams) {
  try {
    ...
    logger.error("Error updating team", _error);
    throw _error;
  }
}
...
export async function deleteTeam(teamId: string) {
  try {
    ...
    logger.error("Error deleting team", _error);
    throw _error;
  }
}
...
export async function getTeam(teamId: string) {
  try {
    ...
    logger.error("Error getting team", _error);
    throw _error;
  }
}
...
export async function getUserTeams() {
  try {
    ...
    logger.error("Error getting user teams", _error);
    throw _error;
  }
}
...
export async function getUserTeamRole(teamId: string, userId?: string) {
  try {
    ...
    logger.error("Error getting user team role", _error);
    return null;
  }
}
